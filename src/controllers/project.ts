import { SocketIoRouteHandler } from "../server-framework"
import { DecodedIdToken } from "../integrations/firebase"
import { CreateProjectRequest, CreateProjectResponse, DeleteProjectRequest, DeleteProjectResponse, UpdateProjectRequest, UpdateProjectResponse, makeSuccessResponse } from "@parkour-ops/airetable-contract"
import { makeErrorResponse } from "@parkour-ops/airetable-contract"
import { createProject, deleteProject, readProject, updateProject  } from "../models/project"
...
> = async (server, socket, tkn, data, callback) => {
    try {
        ...
        callback(makeErrorResponse(500, "Failed to create project."));
    }
}
